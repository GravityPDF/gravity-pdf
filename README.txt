...
* Housekeeping - Move PDF_EXTENDED_TEMPLATES folder to the /wp-content/upload/ directory. Get more info about the move (see http://gravityformspdfextended.com/migrating-template-directory-means/)
