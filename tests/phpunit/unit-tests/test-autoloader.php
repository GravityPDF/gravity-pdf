...
class Test_Autoloader extends WP_UnitTestCase {
	...
	public function provider_classes() {
		return [
			...
			[ 'GFPDF\Abstraction\Abstract_Controller' ],
			[ 'GFPDF\Abstraction\Abstract_Fields' ],
			[ 'GFPDF\Abstraction\Abstract_Form' ],
			[ 'GFPDF\Abstraction\Abstract_Model' ],
			[ 'GFPDF\Abstraction\Abstract_View' ],
			...
			[ 'GFPDF\Abstraction\Abstract_Options' ],
