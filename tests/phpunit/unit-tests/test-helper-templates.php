...
class Test_Templates_Helper extends WP_UnitTestCase {
	...
	public function test_maybe_add_template_compatibility_notice() {
		...
		$this->assertEquals( 'Template (+ needs v' . $version . ')', $this->templates->maybe_add_template_compatibility_notice( 'Template', $version ) );
	}
	 ...
	 *
	 * Tests get_template_config_file(), load_template_config_file() and get_config_class_name()
	 *
	 * @since 4.1
	 */
	public function test_get_template_configuration() {
		...
		/* Test failure first */
		$this->assertEquals( 'stdClass', get_class( $this->templates->get_template_config_file( 'test' ) ) );

		/* Test default template */
		$this->assertEquals( 'GFPDF\Templates\Config\Zadani', get_class( $this->templates->get_template_config_file( 'zadani' ) ) );

		/* Test legacy templates */
		$this->assertEquals( 'GFPDF\Templates\Config\Legacy', get_class( $this->templates->get_template_config_file( 'default-template' ) ) );
	}
	...
	public function test_get_template_args() {
		...
		$data = $this->templates->get_template_arguments(
			...
			$pdf,
			$this->templates->get_template_config_file( $pdf['template'] ),
