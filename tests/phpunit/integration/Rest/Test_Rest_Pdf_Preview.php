...
class Test_Rest_Pdf_Preview extends Test_Rest {
	...
	public function test_create_item_preview() {
		...
		/* Test for forbidden (logged-in editor lacks gravityforms_edit_settings) */
		...
		$this->assertSame( 'headers_sent', $response->get_data()['code'] );
	}
	...
	public function test_create_item_preview_with_entry() {
		...
		$entry = $this->gf_factory()->entry->create_and_get( [ 'form_id' => $this->form_id ] );
