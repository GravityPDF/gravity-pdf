...
class Test_Rest_Custom_Fonts extends TestCase {
	...
	public function set_up(): void {
		...
		$this->controller = new Rest_Custom_Fonts( $this->model, $gfpdf->log, $gfpdf->gform, $gfpdf->get_font_registry(), $gfpdf->get_install_requests(), $this->tmp_font_location, 'GFPDF\\Fonts\\LocalFilesystem', 'GFPDF\\Fonts\\LocalFile' );
