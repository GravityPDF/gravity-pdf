...
class Test_Bootstrap extends TestCase {
	...
	public function test_actions() {
		$this->assertSame( 10, has_action( 'init', [ $this->loader, 'register_assets' ] ) );
		$this->assertSame( 20, has_action( 'admin_enqueue_scripts', [ $this->loader, 'load_admin_assets' ] ) );

		$this->assertSame( 1, has_action( 'init', [ $this->loader, 'init_settings_api' ] ) );
		$this->assertSame( 1, has_action( 'admin_init', [ $this->loader, 'setup_settings_fields' ] ) );
	}
	...
	public function test_dependant_helper_classes( $expected, $property ) {
		$this->assertSame( $expected, get_class( $this->loader->$property ) );
	}
	 ...
	 * @since 4.0
	 */
	public function provider_dependant_helper_classes(): array {
		return [
	...
	public function test_licensing_requirements() {
		...
		$this->assertIsArray( $gfpdf->data->addon );
