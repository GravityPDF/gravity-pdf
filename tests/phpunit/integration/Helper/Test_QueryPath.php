 ...
 * @group querypath
 */
class Test_QueryPath extends TestCase {
	...
	public function test_QueryPath() {
		...
		$this->assertInstanceOf( 'GFPDF_Vendor\QueryPath\DOMQuery', $qp->html5( '<div>Test</div>' ) );
	}
	...
	public function test_utf8() {
		...
		$qp = new Helper_QueryPath();
		$this->assertSame( 'ã   Ã   ╚   ╔   ╩   ╦   ╠   ═   ╬   ¤', $qp->html5( $html, 'div' )->innerHTML5() );
