...
class Test_Singleton extends TestCase {
	...
	public function test_singleton() {
		...
		$this->assertInstanceOf( 'GFPDF\Helper\Helper_Data', $singleton_data );
		$this->assertSame( 'yes', $singleton_data->working );
		$this->assertSame( 'completed', $singleton_data->stuff );
	...
	public function test_registered_classes( $expected, $class ) {
		...
		$this->assertSame( $expected, get_class( $singleton->get_class( $class ) ) );
	...
	public function test_remove_actions_filters() {
		...
		$this->assertSame( 10, has_action( 'admin_init', [ $actions, 'route' ] ) );
