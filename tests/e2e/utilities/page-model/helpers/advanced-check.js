...
class AdvancedCheck {
  constructor () {
    // Shortcode section
    this.confirmationTextCheckbox = Selector('.gform-settings-input__container').find('input').withAttribute('id', 'type0')
    this.confirmationPageCheckbox = Selector('.gform-settings-input__container').find('input').withAttribute('id', 'type1')
    this.confirmationRedirectCheckbox = Selector('.gform-settings-input__container').find('input').withAttribute('id', 'type2')
