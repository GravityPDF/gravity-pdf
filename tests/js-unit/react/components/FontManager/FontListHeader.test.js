...
describe('FontManager - FontListHeader.js', () => {
  ...
  describe('RENDERS COMPONENT', () => {
    test('render <FontListHeader /> component', () => {
      ...
      expect(component.find('div').at(3).text()).toBe('Regular')
      expect(component.find('div').at(4).text()).toBe('Italics')
      expect(component.find('div').at(5).text()).toBe('Bold')
      expect(component.find('div').at(6).text()).toBe('Bold Italics')
    })
  })
})
