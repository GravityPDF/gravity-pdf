...
describe(
	...
	() => {
		it(
		'renders empty because no isCurrentTemplate prop passed',
		() => {
	...
	it(
		'renders current template label',
		() => {
...
describe(
	'<Name /> and <Version /> testing',
	() => {
    it(
		'renders h2 with title but no version',
		() => {
	...
	it(
		'renders h2 with title and version',
		() => {
...
describe(
	...
	() => {
    it(
		'renders empty because no tags prop passed',
		() => {
