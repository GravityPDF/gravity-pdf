...
npm run wp-env run tests-wordpress chmod 777 /var/www/html/wp-content/{plugins,themes} /var/www/html/wp-content/plugins/gravity-pdf /var/www/html/wp-content/plugins/gravity-pdf-test-suite/src/fonts/ /var/www/html/wp-content/uploads/
