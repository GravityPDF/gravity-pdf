			...
			'tools' => apply_filters('gfpdf_settings_tools',
				array(
					'install_fonts' => array(
						...
						'desc'  => sprintf(__("Once you've %suploaded your fonts%s to the %s/fonts/%s directory use this action to complete the installation.", 'pdfextended'), '<a href="https://developer.gravitypdf.com/documentation/language-support/#install-custom-fonts">', '</a>', '<code>', '</code>'),						
						'type'  => 'button',						
						'std'   => __('Install Fonts', 'pdfextended'),
						'options' => 'install_fonts',
						'tooltip' => '<h6>' . __('Install Fonts', 'pdfextended') . '</h6>' . sprintf(__("Custom fonts can be installed and used in your PDFs. Currently only .ttf font files are supported. Once installed, fonts can be set in your custom PDF templates using CSS's %sfont-family%s declaration. %sSee documentation for full installation guide%s.", 'pdfextended'), '<code>', '</code>', '<a href="https://developer.gravitypdf.com/documentation/language-support/#install-custom-fonts">', '</a>'),
					),
					...
					'cleanup' => array(
						...
						'options' => 'cleanup',
						'tooltip' => '<h6>' . __('Cleanup PDFs', 'pdfextended') . '</h6>' . sprintf(__("Any PDFs generated by Gravity PDF which are more than 24 hours old will be removed from your file system. You should run this when you enable the %sRegularly Cleanup PDFs%s setting.", 'pdfextended'), '<em>', '</em>'),
					),							
