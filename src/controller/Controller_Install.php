 ...
 * @since 4.0
 */
class Controller_Install extends Abstract_Controller implements Helper_Interface_Actions, Helper_Interface_Filters {
	 ...
	 *
	 * @param Abstract_Model|\GFPDF\Model\Model_Install $model   Our Install Model the controller will manage
	 * @param \GFPDF\Abstraction\Abstract_Form               $gform   Our Install View the controller will manage
	 ...
	 * @since 4.0
	 */
	public function __construct( Abstract_Model $model, Abstract_Form $gform, LoggerInterface $log, Helper_Notices $notices, Helper_Data $data, Helper_Misc $misc ) {
