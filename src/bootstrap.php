...
class Router implements Helper\Helper_Interface_Actions, Helper\Helper_Interface_Filters {
	...
	public function plugin_action_links( $links ) {
		...
		$action_links = [
			'settings' => '<a href="' . esc_url( $this->data->settings_url ) . '" title="' . esc_attr__( 'View Gravity PDF Settings', 'gravity-pdf' ) . '">' . esc_html__( 'Settings', 'gravity-pdf' ) . '</a>',
		];
	...
	public function load_custom_font_handler(): void {
		...
		$class = new Rest\Rest_Custom_Fonts( $model, $this->log, $this->gform, $this->data->template_font_location );
		$class->init();
