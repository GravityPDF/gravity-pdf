...
class Router implements Helper\Helper_Interface_Actions, Helper\Helper_Interface_Filters {
	...
	private function register_scripts() {
		...
		wp_register_script( 'gfpdf_js_admin', PDF_PLUGIN_URL . 'dist/assets/js/admin.min.js', $pdf_settings_dependancies, $version );
		...
		wp_register_script( 'gfpdf_js_v3_migration', PDF_PLUGIN_URL . 'dist/assets/js/gfpdf-migration.min.js', [ 'gfpdf_js_admin' ], $version );

		/* Localise admin script */
		wp_localize_script( 'gfpdf_js_entrypoint', 'GFPDF', $this->data->get_localised_script_data( $this->options, $this->gform ) );
		wp_localize_script( 'gfpdf_js_admin', 'GFPDF', $this->data->get_localised_script_data( $this->options, $this->gform ) );
	}
	...
	public function load_admin_assets() {
		...
		if ( $this->misc->is_gfpdf_page() ) {
			...
			/* load scripts */
			wp_enqueue_script( 'gfpdf_js_admin' );
