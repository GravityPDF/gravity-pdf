...
<script type="text/template" id="GravityPDFFonts">
    ...
    <div class="font-settings" style="display: none">
		...
		<div class="font-selector">
			...
			<span><input type="button" data-uploader-button-text="<?php _e('Select Font', 'gravity-forms-pdf-extended' ); ?>" data-uploader-title="<?php _e('Select Font', 'gravity-forms-pdf-extended' ); ?>" value="<?php _e('Select Font', 'gravity-forms-pdf-extended' ); ?>" class="gfpdf_settings_upload_button button-secondary"></span>
		</div>
