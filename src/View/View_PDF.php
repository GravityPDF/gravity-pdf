...
class View_PDF extends Helper_Abstract_View {
	...
	public function generate_pdf( $entry, $settings ) {
		...
		_doing_it_wrong( __METHOD__, esc_html__( 'Use \GPDFAPI::create_pdf() to generate PDFs', 'gravity-forms-pdf-extended' ), '6.12' );
	...
	/**
	 * Display the $form_data array on screen, then exit
	 *
	 * @param array $form_data
	 *
	 * @since 6.11.0
