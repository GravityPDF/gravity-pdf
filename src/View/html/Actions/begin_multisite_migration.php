...
<script type="text/javascript">
  var gfpdf_migration_multisite_ids = <?= json_encode( $args['multisite_ids'] ); ?>;
</script>
...
<div class="wrap">
	...
	<div id="gfpdf-multisite-migration-copy" data-nonce="<?= wp_create_nonce( 'gfpdf_multisite_migration' ); ?>">
	...
	<div id="gfpdf-multisite-migration-complete" style="display: none">
		...
		<p><a href="<?= $args['current_page_url']; ?>">Return to current page</a> |
			<a href="<?= $args['gf_forms_url']; ?>">View Gravity Forms</a></p>
	</div>
