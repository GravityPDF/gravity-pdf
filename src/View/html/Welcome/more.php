...
<div class="gfpdf-changelog">
	...
	<div class="feature-section gfpdf-three-col">
		<div class="col gfpdf-breakdown">
			...
			<p><?php printf( esc_html__( "It's like a theme shop, but for Gravity PDF templates. %1\$sHead over to our online store%2\$s and view our growing selection of premium PDF templates.", 'gravity-forms-pdf-extended' ), '<a href="https://gravitypdf.com/store/#templates">', '</a>' ); ?></p>

			<h4><?php esc_html_e( 'Roll your Own', 'gravity-forms-pdf-extended' ); ?></h4>

			<p><?php printf( esc_html__( "If PHP, HTML and CSS come easy to you, you'll find creating your own PDF templates a breeze. With %1\$sextensive documentation and great examples%2\$s you'll be up and running in no time.", 'gravity-forms-pdf-extended' ), '<a href="https://docs.gravitypdf.com/v5/developer-start-customising">', '</a>' ); ?></p>
		...
		<div class="col gfpdf-breakdown">
			...
			<p><?php printf( esc_html__( "If you're looking to enhance Gravity PDF %1\$sour Extension Shop is your first port of call%2\$s. Advanced functionality will be at your fingertips with a premium Gravity PDF extension.", 'gravity-forms-pdf-extended' ), '<a href="https://gravitypdf.com/store/">', '</a>' ); ?></p>
		...
		<div class="col gfpdf-breakdown gfpdf-last-feature">
			...
			<p><?php printf( esc_html__( "If the PDF Shop doesn't have what you're after %1\$sour friendly team can build a document just for you%2\$s. With an addon, our devs can even create templates that auto fill existing PDFs – like government and legal documents.", 'gravity-forms-pdf-extended' ), '<a href="https://gravitypdf.com/bespoke/">', '</a>' ); ?></p>
