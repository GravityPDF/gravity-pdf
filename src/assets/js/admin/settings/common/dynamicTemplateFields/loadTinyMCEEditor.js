/**
 * Initializes AJAX-loaded wp_editor TinyMCE containers for use
...
function restoreLastEditorTab (fullId, mode) {
  ...
  const apply = function () {
    try {
      ...
      const editorWindow = editor && typeof editor.getWin === 'function' ? editor.getWin() : null
      if (editorWindow && typeof editorWindow.getSelection === 'function') {
