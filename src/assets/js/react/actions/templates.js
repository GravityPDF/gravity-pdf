 ...
 * @param { string } text
 *
 * @return {{ type: string, text: string }} action object
 *
 * @since 4.1
 */
 ...
 *
 * @return {{ type: string, id: string }} action object
 *
 * @since 4.1
 */
 ...
 *
 * @return {{ type, template: Object }} action object
 *
 * @since 4.1
 */
 ...
 *
 * @return {{ type: string, id: string, name: string, value: string }} action object
 *
 * @since 4.1
 */
 ...
 *
 * @return {{ type, payload: string }} action object
 *
 * @since 5.2
 */
