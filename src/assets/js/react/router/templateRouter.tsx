...
/**
 * Pure route definitions for the Advanced Template Selector.
 *
 * Rendered inside the single HashRouter managed by templateBootstrap — no
 * router wrapper here. Routes include:
 *
 * /template       (../components/Template/TemplateList)
 * /template/:id   (../components/Template/TemplateSingle)
 *
 * @package			Gravity PDF
