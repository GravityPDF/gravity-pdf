...
<div class="wrap about-wrap gfpdf-update-screen">
	...
	<div class="about-text">
		<?php _e( "Gravity PDF has been completely rebuilt with simplicity, stability and security in mind. Our team has spent over ten months making a great product even greater. Discover what's new...", 'gravity-forms-pdf-extended' ); ?>
	</div>
	...
	<div class="feature-section two-col">
		...
		<div class="col">
			...
			<p>
				<?php _e( "We've done away with the need to edit PHP files to configure Gravity PDF. You'll have a familiar and seamless experience controlling PDF settings direct from your WordPress Admin area.", 'gravity-forms-pdf-extended' ); ?>
			</p>
	...
	<div class="feature-section two-col">
		...
		<div class="col">
			...
			<p>
				<?php printf( __( "We were always getting feedback for templates that look more like their Gravity Forms layouts. %sYou asked and we've delivered!%s", 'gravity-forms-pdf-extended' ), '<strong>', '</strong>' ); ?>
			</p>
