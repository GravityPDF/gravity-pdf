...
class Helper_Data {
	...
	public function addon_license_responses( $addon_name ) {
		return [
			...
			'inactive'            => __( 'Your license key is valid but is not activated on any website. This usually occurs if the site was removed from your account. Please resave the settings to activate the license for this website.', 'gravity-pdf' ),
	 ...
	 *
	 * @since  4.0
	 * @since  7.0 Added the $templates parameter
	 */
