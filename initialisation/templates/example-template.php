	...
	<body>
        ...
        foreach($lead_ids as $lead_id) {
           ...
           <div class="body_copy">
				...
				To start with, you'll want to copy and rename one of the <em>example-</em> template files in your active theme's PDF_EXTENDED_TEMPLATES directory. <strong>Note: Some releases will push template updates for the default- and example- template files and these files are overridden when the software is reinitalised. Don't modify them directly.</strong> </p>				
