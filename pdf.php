...
define( 'PDF_EXTENDED_VERSION', '4.0-RC4' ); /* the current plugin version */
...
class GFPDF_Major_Compatibility_Checks {
	...
	public function check_wordpress() {
		...
		if ( ! version_compare( $wp_version, $this->required_wp_version, '>=' ) ) {
			$this->notices[] = sprintf( __( 'WordPress Version %s is required. %sGet more info%s.', 'gravity-forms-pdf-extended' ), $this->required_wp_version, '<a href="https://gpdfv4.xyz/documentation/v4/user-activation-errors/#wordpress-version">', '</a>' );
	...
	public function check_gravity_forms() {
		...
		if ( ! class_exists( 'GFCommon' ) || ! version_compare( GFCommon::$version, $this->required_gf_version, '>=' ) ) {
			$this->notices[] = sprintf( __( '%sGravity Forms%s Version %s is required. %sGet more info%s.', 'gravity-forms-pdf-extended' ), '<a href="https://www.e-junkie.com/ecom/gb.php?cl=54585&c=ib&aff=235154">', '</a>', $this->required_gf_version, '<a href="https://gpdfv4.xyz/documentation/v4/user-activation-errors/#gravityforms-version">', '</a>' );
	...
	public function check_php() {
		...
		if ( ! version_compare( phpversion(), $this->required_php_version, '>=' ) ) {
			$this->notices[] = sprintf( __( 'You are running an %soutdated version of PHP%s. Contact your web hosting provider to update. %sGet more info%s.', 'gravity-forms-pdf-extended' ), '<a href="http://www.wpupdatephp.com/update/">', '</a>', '<a href="https://gpdfv4.xyz/documentation/v4/user-activation-errors/#php-version">', '</a>' );
	...
	public function check_mb_string() {
		...
		if ( ! extension_loaded( 'mbstring' ) ) {
			$this->notices[] = sprintf( __( 'The PHP Extension MB String could not be detected. Contact your web hosting provider to fix. %sGet more info%s.', 'gravity-forms-pdf-extended' ), '<a href="https://gpdfv4.xyz/documentation/v4/user-activation-errors/#php-mbstring">', '</a>' );
	...
	public function check_mb_string_regex() {
		...
		if ( extension_loaded( 'mbstring' ) && ! function_exists( 'mb_regex_encoding' ) ) {
			$this->notices[] = sprintf( __( 'The PHP Extension MB String does not have MB Regex enabled. Contact your web hosting provider to fix. %sGet more info%s.', 'gravity-forms-pdf-extended' ), '<a href="https://gpdfv4.xyz/documentation/v4/user-activation-errors/#php-mbstring-regex">', '</a>' );
	...
	public function check_gd() {
		...
		if ( ! extension_loaded( 'gd' ) ) {
			$this->notices[] = sprintf( __( 'The PHP Extension GD Image Library could not be detected. Contact your web hosting provider to fix. %sGet more info%s.', 'gravity-forms-pdf-extended' ), '<a href="https://gpdfv4.xyz/documentation/v4/user-activation-errors/#php-gd">', '</a>' );
	...
	public function check_dom() {
		...
		if ( ! extension_loaded( 'dom' ) || ! class_exists( 'DOMDocument' ) ) {
			$this->notices[] = sprintf( __( 'The PHP DOM Extension was not found. Contact your web hosting provider to fix. %sGet more info%s.', 'gravity-forms-pdf-extended' ), '<a href="https://gpdfv4.xyz/documentation/v4/user-activation-errors/#php-dom">', '</a>' );
		...
		if ( ! extension_loaded( 'libxml' ) ) {
			$this->notices[] = sprintf( __( 'The PHP Extension libxml could not be detected. Contact your web hosting provider to fix. %sGet more info%s.', 'gravity-forms-pdf-extended' ), '<a href="https://gpdfv4.xyz/documentation/v4/user-activation-errors/#php-xml">', '</a>' );
	...
	public function check_ram( $ram ) {
		...
		if ( $ram < 64 && $ram !== -1 ) {
			$this->notices[] = sprintf( __( "You need %s128MB%s of WP Memory (RAM) but we only found %s available. %sTry these methods to increase your memory limit%s, otherwise contact your web hosting provider to fix.", 'gravity-forms-pdf-extended' ), '<strong>', '</strong>', $ram . 'MB', '<a href="https://gpdfv4.xyz/documentation/v4/user-increasing-memory-limit/">', '</a>' );
