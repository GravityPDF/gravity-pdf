 ...
 */
define( 'PDF_EXTENDED_VERSION', '5.0.0-RC1' ); /* the current plugin version */
...
class GFPDF_Major_Compatibility_Checks {
	 ...
	 * @since 4.0
	 */
	public $required_gf_version = '2.3-rc-1';
	...
	public function check_gravity_forms() {
		...
		if ( ! class_exists( 'GFCommon' ) || ! version_compare( GFCommon::$version, $this->required_gf_version, '>=' ) ) {
			$this->notices[] = sprintf( esc_html__( '%sGravity Forms%s Version %s is required. %sGet more info%s.', 'gravity-forms-pdf-extended' ), '<a href="https://www.e-junkie.com/ecom/gb.php?cl=54585&c=ib&aff=235154">', '</a>', $this->required_gf_version, '<a href="https://gravitypdf.com/documentation/v5/user-activation-errors/#gravityforms-version">', '</a>' );
