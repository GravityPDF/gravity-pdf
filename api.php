...
final class GPDFAPI {
	...
	public static function add_pdf_font( $font ) {
		...
		$controller = new \GFPDF\Rest\Rest_Custom_Fonts( $model, self::get_log_class(), self::get_form_class(), $gfpdf->get_font_registry(), $data->template_font_location, '\GFPDF\Fonts\LocalFilesystem', '\GFPDF\Fonts\LocalFile' );
